-- complete_schema.sql
-- Consolidated production schema for Supabase (project: xgnlydivsecwodwhdvky)
-- Auto-generated by concatenating all migrations in supabase/migrations/ in chronological order.
-- Run once in a fresh Supabase project's SQL editor. Safe re-runs use IF EXISTS / IF NOT EXISTS guards already inside each migration.
...
-- =============================================================
-- 20260606134520_c342f042-a41c-465a-9603-3aadc9edf688.sql
-- =============================================================
-- Roles infra
DO $$ BEGIN
...
CREATE INDEX idx_content_versions_target ON public.content_versions(target_kind, target_key, created_at DESC);
...
-- =============================================================
-- 20260606134807_77cbbc3a-1f05-4c46-b7ee-bf91e16badc0.sql
-- =============================================================
do $$ begin
...
-- =============================================================
-- 20260606134923_3b67396f-abe1-4144-9360-655613ffa29d.sql
-- =============================================================
...
-- =============================================================
-- 20260606135033_df22bf78-4866-4419-aa56-6facbe72df8b.sql
-- =============================================================
...
-- =============================================================
-- 20260606141018_576c0c75-2a5f-4a25-a56a-10e8cfba4a89.sql
-- =============================================================
...
-- =============================================================
-- 20260606143322_6f3b4743-b181-4364-b550-d0aab7222119.sql
-- =============================================================
...
-- =============================================================
-- 20260606151151_783c1a42-0597-4ef3-949a-25a3bebd6fef.sql
-- =============================================================
-- Roles infra
DO $$ BEGIN
  CREATE TYPE public.app_role AS ENUM ('admin','moderator','user');
...
ALTER TABLE public.user_sessions REPLICA IDENTITY FULL;
-- =============================================================
-- 20260606151335_36b946dc-769c-4dc9-8fcf-357342dac23c.sql
-- =============================================================
do $$ begin
  create type public.content_status as enum ('draft','published','archived');
exception when duplicate_object then null; end $$;
...
create policy "notification_reads_own" on public.notification_reads for all using (user_id = auth.uid());
-- =============================================================
-- 20260606151454_a7c5bc5d-db2a-4da7-bb62-64381f558e9b.sql
-- =============================================================
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'student';
...
GRANT EXECUTE ON FUNCTION public.admin_hard_delete_user(uuid) TO authenticated;
-- =============================================================
-- 20260606151606_ccc194e2-37aa-4f0a-ae18-cf79b7268f0b.sql
-- =============================================================
CREATE TABLE IF NOT EXISTS public.activity_events (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id uuid NULL,
...
GRANT EXECUTE ON FUNCTION public.admin_user_activity(uuid, integer) TO authenticated;
-- =============================================================
-- 20260606151754_03e2b33c-bfe1-4c52-92d6-a52c6fe5f489.sql
-- =============================================================
...
-- =============================================================
-- 20260606153310_3a615b0f-652f-48be-a304-bfead22b453a.sql
-- =============================================================
...
-- =============================================================
-- 20260606180547_52760eac-79c1-4b53-b985-8c0cb3a49e91.sql
-- =============================================================
-- Roles infra
DO $$ BEGIN
  CREATE TYPE public.app_role AS ENUM ('admin','moderator','user');
...
ALTER TABLE public.user_sessions REPLICA IDENTITY FULL;
-- =============================================================
-- 20260606180751_de28e5b1-e55d-433a-8dc6-f27b6e8b2bfd.sql
-- =============================================================
do $$ begin
  create type public.content_status as enum ('draft','published','archived');
exception when duplicate_object then null; end $$;
...
-- =============================================================
-- 20260606181037_64f1ba7b-c1f8-4ec9-abe4-17368a55cb50.sql
-- =============================================================
-- See /tmp/remaining.sql; pasted inline below

-- =============================================================
-- 20260606181454_664c615b-40ea-4f20-9463-9d47c6befd79.sql
-- =============================================================
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS status text NOT NULL DEFAULT 'active'
    CHECK (status IN ('active','suspended','pending')),
...
-- =============================================================
-- 20260606181535_71559e22-40ea-4663-a6ce-5d5bee879c44.sql
-- =============================================================
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'student';
-- =============================================================
-- 20260606181615_066ce9eb-094f-4ac7-bda8-e25caab5fe1a.sql
-- =============================================================
ALTER TABLE public.mcqs ALTER COLUMN option_c DROP NOT NULL;
ALTER TABLE public.mcqs ALTER COLUMN option_d DROP NOT NULL;
ALTER TABLE public.mcqs
...
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
-- =============================================================
-- 20260606182353_82320132-0bdb-4172-957f-6772557f2ccf.sql
-- =============================================================
...
-- =============================================================
-- 20260607143112_8d5d567b-60bc-45da-9d34-0429d23a9013.sql
-- =============================================================
-- Roles infra
DO $$ BEGIN
  CREATE TYPE public.app_role AS ENUM ('admin','moderator','user');
...
ALTER TABLE public.user_sessions REPLICA IDENTITY FULL;
-- =============================================================
-- 20260607143300_49b7215e-4290-4c18-98cf-a9e3b7a99d51.sql
-- =============================================================
do $$ begin
  create type public.content_status as enum ('draft','published','archived');
exception when duplicate_object then null; end $$;
...
create policy "notification_reads_own" on public.notification_reads for all using (user_id = auth.uid());
-- =============================================================
-- 20260607143412_7444ad82-d974-488c-a53e-5fb3b62a7a81.sql
-- =============================================================
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'student';
...
GRANT EXECUTE ON FUNCTION public.admin_hard_delete_user(uuid) TO authenticated;
-- =============================================================
-- 20260607143518_1a3450ee-73db-4e60-9446-ba8a0205d908.sql
-- =============================================================
CREATE TABLE IF NOT EXISTS public.activity_events (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id uuid NULL,
...
GRANT EXECUTE ON FUNCTION public.admin_user_activity(uuid, integer) TO authenticated;
-- =============================================================
-- 20260607143810_cf1591d7-21b0-4010-b4d1-ff2b35fcb649.sql
-- =============================================================
...
-- =============================================================
-- 20260607185209_fc27a0c6-f5eb-4999-8e52-3d1d8a9c4e79.sql
-- =============================================================
...
-- =============================================================
-- 20260607185312_aa42e662-b3f7-458b-9f82-dcc9bc24a85f.sql
-- =============================================================
...
-- =============================================================
-- 20260608035527_39a98bed-e94e-4598-99b7-92ce58961424.sql
-- =============================================================
...
-- =============================================================
-- 20260608040610_0e0e1095-58d6-43f6-83c1-c38dbb706b43.sql
-- =============================================================
...
-- =============================================================
-- 20260608041553_919fdd72-1d39-4205-8781-ab37188b12f3.sql
-- =============================================================
SELECT 1;
-- =============================================================
-- 20260608041742_4f399ef0-b01b-481d-9934-a1124c00d4de.sql
-- =============================================================
-- Roles infra
DO $$ BEGIN
  CREATE TYPE public.app_role AS ENUM ('admin','moderator','user');
...
ALTER TABLE public.user_sessions REPLICA IDENTITY FULL;
-- =============================================================
-- 20260608041915_f7aeafb0-4618-49d2-878c-f6ca63b7c352.sql
-- =============================================================
do $$ begin
  create type public.content_status as enum ('draft','published','archived');
exception when duplicate_object then null; end $$;
...
create policy "notification_reads_own" on public.notification_reads for all using (user_id = auth.uid());
-- =============================================================
-- 20260608042024_500f817a-ea21-4642-8b38-8e0016cfe870.sql
-- =============================================================
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'student';
...
GRANT EXECUTE ON FUNCTION public.admin_hard_delete_user(uuid) TO authenticated;
-- =============================================================
-- 20260608042127_c500d938-30bd-4e49-b3c6-3141f1872a32.sql
-- =============================================================
CREATE TABLE IF NOT EXISTS public.activity_events (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id uuid NULL,
...
GRANT EXECUTE ON FUNCTION public.admin_user_activity(uuid, integer) TO authenticated;
-- =============================================================
-- 20260608042210_a3a3021e-f18b-45fe-a2ca-556947149d88.sql
-- =============================================================
CREATE TABLE IF NOT EXISTS public.study_sessions (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id uuid NOT NULL,
...
CREATE INDEX IF NOT EXISTS quiz_sessions_user_status_idx ON public.quiz_sessions (user_id, status);
-- =============================================================
-- 20260608042326_2067cac0-1ae9-4fab-8b81-fb92f2a896d9.sql
-- =============================================================
ALTER TABLE public.mcqs
  ADD COLUMN IF NOT EXISTS question_type text NOT NULL DEFAULT 'mcq'
    CHECK (question_type IN ('mcq', 'true_false'));
...
CREATE TRIGGER mcqs_validate_question_type_trg
  ...
  FOR EACH ROW EXECUTE FUNCTION public.mcqs_validate_question_type();
-- =============================================================
-- 20260608042411_7bdc7639-0ccd-45d9-8efc-5d7eff7f12f5.sql
-- =============================================================
CREATE TABLE IF NOT EXISTS public.site_pages (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  slug text NOT NULL UNIQUE,
...
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
-- =============================================================
-- 20260608042905_0591f81b-62ac-48e5-acc6-ebf21543b118.sql
-- =============================================================
...
-- =============================================================
-- 20260608173325_2d0249c3-04ec-4e76-abce-88896b70dd29.sql
-- =============================================================
...
-- =============================================================
-- 20260608173438_bdbb5383-0cac-40fc-a251-a688772e45a3.sql
-- =============================================================
DROP FUNCTION IF EXISTS public._lovable_import_exec(text);
-- =============================================================
-- 20260608173747_b2f810b5-55fb-48a2-a6d0-72cc6e87d3dd.sql
-- =============================================================
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'super_admin';
-- =============================================================
-- 20260608173829_119a4e53-5144-4c40-bff0-0aba6c9a1adb.sql
-- =============================================================
...
-- =============================================================
-- 20260608174559_1ec164aa-2008-48e4-8bed-33fa84c6967b.sql
-- =============================================================
...
-- =============================================================
-- 20260608175734_89957c0f-4927-497b-bc6f-678c54762f52.sql
-- =============================================================
GRANT EXECUTE ON FUNCTION public.has_role(uuid, public.app_role) TO authenticated, anon;
-- =============================================================
-- 20260609032640_e69d4a08-4eee-4858-a898-6e38077ca437.sql
-- =============================================================
-- See /tmp/all_migrations.sql; passing inline below
-- =============================================================
-- 20260609032722_975a1b34-c0c9-4722-951e-5338a713f1d5.sql
-- =============================================================
SELECT 1;
-- =============================================================
-- 20260609034532_b6f71cc1-380d-466b-8eff-33283b5bf4ef.sql
-- =============================================================
...
-- =============================================================
-- 20260609035412_3575f812-0ea5-4fb8-b530-b221785cc5b3.sql
-- =============================================================
...
-- =============================================================
-- 20260609044045_6521e6bd-5d4b-4b36-b8d9-dfbdf52fe05b.sql
-- =============================================================
CREATE OR REPLACE FUNCTION public._bootstrap_exec(_sql text) RETURNS void LANGUAGE plpgsql AS $$ BEGIN EXECUTE _sql; END $$; REVOKE ALL ON FUNCTION public._bootstrap_exec(text) FROM PUBLIC;
-- =============================================================
-- 20260609044117_61e51541-75c3-4d81-b4cf-389d9705e35d.sql
-- =============================================================
GRANT USAGE, CREATE ON SCHEMA public TO service_role; GRANT ALL ON ALL TABLES IN SCHEMA public TO service_role; GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO service_role; ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON TABLES TO service_role; ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON SEQUENCES TO service_role;
-- =============================================================
-- 20260609044142_e2f19ee4-e032-48e4-a6fe-6ac1d3501e23.sql
-- =============================================================
CREATE OR REPLACE FUNCTION public._bootstrap_exec(_sql text) RETURNS void LANGUAGE plpgsql SECURITY DEFINER SET search_path = public, auth, extensions AS $$ BEGIN EXECUTE _sql; END $$;
-- =============================================================
-- 20260609044218_8d457bec-8295-4a29-b888-f15300bac8c2.sql
-- =============================================================
...
-- =============================================================
-- 20260609044511_1977bcd2-a6ec-4023-8ecd-0eca8b61b700.sql
-- =============================================================
...
-- =============================================================
-- 20260609052016_c6e0071e-e430-4fb5-a833-be10ade1240a.sql
-- =============================================================
...
-- =============================================================
-- 20260609052652_fb6e3595-fdd2-41d2-8f35-368e854ee601.sql
-- =============================================================
...
-- =============================================================
-- 20260609053230_19c507ed-7e50-4b94-a1da-95bd15a49d20.sql
-- =============================================================
...
-- =============================================================
-- 20260609154435_c29fd268-9556-48c5-b1ff-448a15a43a10.sql
-- =============================================================
...
-- =============================================================
-- 20260609154505_5baaeb0a-71c3-4640-b550-e68e24e6923e.sql
-- =============================================================
...
-- =============================================================
-- 20260609173140_f42754ce-df87-450d-8c8e-07113aafb478.sql
-- =============================================================
...
-- =============================================================
-- 20260609175152_ccb4c308-28fb-42d0-9008-7ac1b85bae10.sql
-- =============================================================
GRANT SELECT ON public.user_roles TO authenticated;
GRANT ALL ON public.user_roles TO service_role;
...
-- =============================================================
-- 20260611145417_366ec833-847a-420e-98f8-7302d64c5386.sql
-- =============================================================
...
-- =============================================================
-- 20260611150036_222cfb2f-2515-4939-8198-9afdef928491.sql
-- =============================================================
...
GRANT ALL ON public.content_versions TO service_role;
-- =============================================================
-- 20260611152022_f1a8dfa1-3ba2-44ef-8993-07f8110b0094.sql
-- =============================================================
...
-- =============================================================
-- 20260611160000_user_management_phase2.sql
-- =============================================================
-- =============================================================
